...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <link rel="stylesheet" href="<%= ResolveUrl("Content/front-end/styles/breakpoints.css") %>" />
    <link rel="stylesheet" href="<%= ResolveUrl("Content/front-end/styles/profile-user.css") %>" />
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="profile-container">
        <div class="user-info">
            <asp:Image runat="server" ImageUrl="Content/front-end/images/robert_fox.png" alt="profile-img" />
