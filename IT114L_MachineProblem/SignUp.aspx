                ...
                <div class="container">
                    <div class="left">
                        <div class="form-wrapper">
                            ...
                            <div class="signup-form">
                                ...
                                <div class="input-wrap w-70">
                                    <asp:TextBox runat="server" CssClass="input-field" ID="txtConfirmPassword" TextMode="Password" AutoCompleteType="Disabled" required=""/>
                    ...
                    <div class="right">
                        <div class="image-wrapper">
                            <img src="Content/front-end/images/loginbg.jpg" class="img" runat="server" id="imgBg"/>
                            <div class="wave-wrap">
